# -*- coding: utf-8 -*-
#
# JSON Schema Toolkit documentation build configuration file, created by
...
texinfo_documents = [
  ('index', 'JSONSchemaToolkit', u'JSON Schema Toolkit Documentation',
   u'Alexis Petrounias <www.petrounias.org>', 'JSONSchemaToolkit', 'One line description of project.',
   'Miscellaneous'),
]
